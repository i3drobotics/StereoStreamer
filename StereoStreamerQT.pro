...
INCLUDEPATH += "$$_PRO_FILE_PWD_/src/stereostreamerqt"
VPATH += $$_PRO_FILE_PWD_/src
VPATH += $$_PRO_FILE_PWD_/src/stereostreamerqt

SOURCES += \
        stereostreamerqtmain.cpp \
        udpwidget.cpp \
        udpwindow.cpp
